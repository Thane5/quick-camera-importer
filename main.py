...
# pyinstaller command: pyinstaller --onefile --noconsole --add-data "MainWindow.ui;." --add-data "appicon.ico;." --icon=appicon.ico --hiddenimport win32timezone --collect-data sv_ttk --name quickcameraimporter main.py
